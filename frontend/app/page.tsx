    ...
    <main className="py-8 mx-40">
      <header className="flex justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          />
          {
            !isVerified && (<button className="px-4 py-2 bg-indigo-500 text-white rounded-md">Verify Account</button>)
          ...
          <h1>
            ...
            {isOpen && (
              <form action="" className="mt-4 min-w-10 max-w-sm w-full ">
                ...
                <button type="submit" onClick={(e) => updateUser(e, {bio : userState.bio})} className="mt-4  px-4 py-2 bg-indigo-800 text-white rounded-md hover:bg-indigo-700">
                  Update Bio
                </button>
              </form>
            )}
